  ...
  void _showAdminPasswordDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => Directionality(
        ...
        child: AlertDialog(
          title: const Text('كلمة مرور لوحة التحكم 🔒', style: TextStyle(color: Color(0xFF7B1FA2), fontWeight: FontWeight.bold)),
          content: TextField(
            controller: passwordController,
            obscureText: true,
            decoration: const InputDecoration(
              labelText: 'أدخلي كلمة المرور الخاصة بكِ',
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (passwordController.text.trim() == '125587') {
                  Navigator.pop(context);
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const AdminBlogScreen()),
                  );
                } else {
